...
val path = "/project_phase2/04temporal_visualization/annual/" + characteristicName
val output_path = "/project_phase2/04temporal_visualization/seasonal/" + characteristicName + "/"
