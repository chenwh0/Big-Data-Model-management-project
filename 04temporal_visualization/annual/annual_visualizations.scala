...
val characteristicName = "total_suspended_solids" // CHANGE THIS TO DIFFERENT CHARACTERSITICNAMES ["nitrogen", "temperature", "phosphorus", "pH", "dissolved_oxygen", "total_suspended_solids"]

val path = "/project_phase2/" + characteristicName
val output_path = "/project_phase2/04temporal_visualization/annual/" + characteristicName
